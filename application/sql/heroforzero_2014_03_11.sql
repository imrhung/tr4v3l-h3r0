...
CREATE TABLE `donation` (
  `Id` int(11) NOT NULL,
  `Tilte` varchar(150) DEFAULT NULL,
...
--
-- Table structure for table `user_of_me`
--

DROP TABLE IF EXISTS `user_of_me`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_of_me` (
  `Id` int(11) NOT NULL,
...
-- Dump completed on 2014-03-11 16:37:47
